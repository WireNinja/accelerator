...
- Per-stage `OPS_DEPLOY_{STAGE}_HTTP_RUNTIME` selects `fpm` or `octane`. FPM is the scaffold default and can auto-detect `_FPM_SOCKET`; Octane requires `_OCTANE_PORT` and uses `_OCTANE_SERVER`.
