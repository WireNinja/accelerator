...
php artisan accelerator:deploy:init --stage=staging
...
develop -> verify -> commit/push -> deploy staging -> developer/client approval
   ...
   +---------------- rejected/fix -----------------------+
                                                      ...
                                                      approved
                                                         |
                                                         v
                                              deploy same commit to production
```
...
```text
develop -> verify -> commit/push -> deploy staging -> approval -> deploy production
```
