...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Project Filament v5 Warning
    |--------------------------------------------------------------------------
    |
    | Project ini tidak memakai bulk actions. Jangan gunakan bulkActions(),
    | pushBulkActions(), groupedBulkActions(), getBulkActions(), atau
    | toolbarActions() untuk flow bulk table. API bulk lama itu deprecated di
    | Filament v5, dan composer phpstan di repo ini sekarang memuat rules
    | deprecation untuk mendeteksi pemakaian yang tersisa.
    |
    */
