...
/**
 * @deprecated The `resource` subject is retained only for legacy compatibility.
 *             Inspect registered Filament resources and policies directly.
 *             Model and list context remain supported.
 */
